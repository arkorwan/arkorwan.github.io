---
layout: post
title: กลยุทธ์แตกพรรคเพื่อเอาชนะระบบเลือกตั้ง '62
frappecharts: true
---
...
มาดูจาก[ไทยโพสต์](https://www.thaipost.net/main/detail/21715)บ้าง (11 พษศจิกายน 2561 -- หลัง ทษช. เปิดตัวแล้ว)
...
#### เพื่อไทย
{% include_relative game-the-election/voting_chart.html chart_name="chart_pt" franchises_data="[0, 116, 60, 113, 111]" main_data="[240, 124, 204, 153, 204]" colors="['#ff9393', '#d12340']" %}

#### ประชาธิปัตย์
{% include_relative game-the-election/voting_chart.html chart_name="chart_dm" franchises_data="[0, 79, 68, 109, 106]" main_data="[171, 91, 115, 77, 115]" colors="['light-blue', '#4286f4']" %}

#### ภูมิใจไทย
{% include_relative game-the-election/voting_chart.html chart_name="chart_pj" franchises_data="[0, 31, 40, 41, 44]" main_data="[59, 28, 29, 28, 29]" colors="['#91aeff', '#5a338c']" %}
...
ทำไปทำมา ไม่แน่ว่าพรรคที่ได้ประโยชน์จากกติกาใหม่มากที่สุด อาจจะเป็นพรรคที่โวยมากที่สุดอย่างเพื่อไทยก็ได้

## แล้วไงต่อ?

บล็อกนี้เกิดจากความสงสัยว่าการแตกพรรคมีประโยชน์อย่างไร ตอนนี้เราได้คำตอบแล้วว่าเป็นวิธีการที่ใช้ได้จริง และวิธีที่เพื่อไทยใช้ก็น่าจะผ่านการศึกษามาแล้วเป็นอย่างดี
