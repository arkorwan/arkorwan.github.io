...
อย่างแรกเลย ดูที่ผู้สมัคร[บัญชีรายชื่อ](https://www.thaipost.net/main/detail/28393)ของ "พรรค A" หรือเพื่อไทย
คือกลยุทธ์นี้ ถ้าประสบความสำเร็จ **พรรคหลักจะต้องไม่ได้ ส.ส. party list เลยแม้แต่คนเดียว**
พูดอีกอย่างหนึ่ง ถ้าเพื่อไทยได้ party list แสดงว่ากลยุทธ์นี้ล้มเหลว

แต่พอดูแล้วก็จะพบว่า แกนนำเบอร์ใหญ่ๆ ของพรรคก็อยู่ในบัญชีรายชื่อทั้งนั้น ไม่ว่าจะป๋าเหนาะ เฉลิม ปลอดประสพ
...
สมมติฐานของเราเริ่มจะสั่นคลอนแล้วสิ

คำอธิบายอาจจะเป็นว่า:
1. เป็นความเต็มใจ ความเป็น ส.ส.อาจไม่ได้สำคัญขนาดนั้น
...
ข้อแรกนี่ฟังดูโลกสวย แต่เราก็เห็นแล้วว่า อ.ชัชชาติ ก็ลงพื้นที่หาเสียง ทั้งๆ ที่ไม่มีชื่อเป็น ส.ส. เป็นแค่แคนดิเดตนายกฯ "ตัวสำรอง"
ก็มองได้ว่าแกนนำเหล่านี้ถูกวาง position ไว้เป็นรัฐมนตรีเลย ไม่ใช่ ส.ส. ดังนั้นก็อาจจะพอมีความเป็นไปได้
...
แล้วโดนหลอกมา "เข้ากรุ"

รวมๆ แล้วผมว่า ความเป็นไปได้น่าจะอยู่ที่ส่วนผสมของข้อ 1 กับ 3 คือเอาแกนนำระดับที่วางตัวไว้เป็น รมต. มาลง party list
ถ้ามองแบบนี้ สมมติฐานการใช้กลยุทธ์แบ่งพรรคก็ยังใช้ได้อยู่

## ทษช เล่นบทพรรค B จริงหรือไม่

มาต่อกันที่ประเด็นที่ค้างเอาไว้ ก็คือดูว่า *การส่งผู้สมัคร ส.ส. เขต ของ ทษช สอดคล้องกับการเป็นพรรค B
...
(รวมถึงกรณีที่พรรครองแซงชนะซะเองด้วย)
...
*หรือว่าจริงๆ แล้ว เฮียแม้วไม่ได้ใช้กลยุทธ์นี้หว่า?*
...
คราวนี้เห็นได้ชัดเลยว่า ทีแรก ทษช ก็เล่นตามกลยุทธ์แบ่งพรรคตรงตามสคริปต์ คือเน้นส่งผู้สมัครในเขตที่คาดว่าน่าจะแพ้เป็นหลัก
และเขตที่ทับซ้อนกับพรรคหลักก็มีไม่มาก คือแค่ 23 เขต หรือ 6.5% เท่านั้นเอง **แต่ทันทีที่ประกาศชื่อแคนดิเดตนายกฯ
ก็มีการเปลี่ยน strategy การส่งผู้สมัคร** เบนออกไปจากแผนเดิม

ซึ่งอาจจะตีความได้ว่า มีการประเมินมาแล้วว่าคะแนนที่จะได้เพิ่มจากทูลกระหม่อมฯ
...
ถ้าการเสนอชื่อทูลกระหม่อมฯ เป็นแผนการที่วางไว้แต่แรก แล้วมีเหตุผลอะไรที่ ทษช จะส่งผู้สมัครตามกลยุทธ์เดิม
...
ชัดเจนที่สุดคือการที่ เพื่อไทยไม่ได้ส่งผู้สมัครเพิ่มเลย ซึ่งในเมื่อไหนๆ จะไม่ใช้แผนเดิมแล้ว ถ้ามองเห็นแล้วว่า ทษช อาจจะโดนยุบพรรค
เพื่อไทยก็ควรจะเปลี่ยนใจมาส่งผู้สมัครเพื่มเพื่อเก็บคะแนน party list บ้าง
เพราะในสถานการณ์ปัจจุบันนี้ **เพื่อไทยน่าจะไม่ได้ party list เลย**
...
ลองสมมติดูว่า ถ้าเราคาดไว้แล้วว่าอาจถูกยุบพรรค ก็น่าจะเสนอชื่อเกิดขึ้นเร็วกว่านี้ซัก 2-3 วัน เพื่อดูกระแสตอบรับ
มันก็จะมีเวลาให้ขยับตัวทำอะไรได้บ้างก่อนจะหมดเวลารับสมัคร

จากความไม่ make sense เหล่านี้ สมมติฐานว่าการถูกยุบพรรคอยู่แผนการอยู่แล้วจึงไม่น่าจะใช่
